                    ...
                    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                        {[
                            ...
                            <button
                                ...
                                className={`group relative overflow-hidden rounded-xl border-2 px-4 py-4 text-sm font-semibold shadow-sm transition-all duration-200 ${
        ...
        <div className="space-y-5">
            <div className="flex items-center gap-2">
                ...
                <div>
                    ...
                    <p className="text-sm text-slate-500">What would you most like to address?</p>
                </div>
            </div>
            ...
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                {CONCERN_OPTIONS.map((option) => (
                    <button
                        ...
                        className={`group relative overflow-hidden rounded-xl border-2 px-5 py-4 text-center text-sm font-semibold shadow-sm transition-all duration-200 ${
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                {SENSITIVITY_OPTIONS.map((option) => (
                    <button
                        ...
                        className={`group relative overflow-hidden rounded-xl border-2 px-5 py-5 text-center text-sm font-semibold shadow-sm transition-all duration-200 ${
                        ...
                        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
                            {LIFESTYLE_OPTIONS[field.key].map((option) => (
                                <button
                                    ...
                                    className={`group relative overflow-hidden rounded-xl border-2 px-5 py-4 text-left shadow-sm transition-all duration-200 ${
            ...
            <div className="space-y-5">
                ...
                <div className="flex flex-wrap gap-3">
                    ...
                    <Button
                        ...
                        className={`inline-flex items-center gap-2 rounded-xl border-2 px-6 py-3.5 text-sm font-semibold shadow-sm transition-all duration-200 ${
                            cameraActive 
