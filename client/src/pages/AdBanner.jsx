...
export default function AdBanner() {
  ...
  return (
    <section
      className="
        relative h-[85vh] flex items-center
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <p className="mt-6 max-w-xl text-lg text-slate-700">
          ...
          dermatologist-approved products tailored specifically for you.
        ...
        <div className="mt-8 flex gap-4">
          ...
          <button className="rounded-xl border border-slate-300 bg-white/70 backdrop-blur px-6 py-3 font-semibold hover:bg-white transition">
            Browse Products
          </button>
        </div>
